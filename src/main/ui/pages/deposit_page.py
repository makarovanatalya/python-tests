...
class DepositPage(BasePage):
    ...
    def fill_deposit_form(self, account_number: str = None, amount: str = None):
        with allure.step(f"fill deposit form with {account_number=} and {amount=}"):
            ...
            screenshot.attach_page_screenshot(self.page, "send_deposit_form")
        return self

    def send_deposit_form(self, message: str = None, context_manager=True):
        with allure.step("send deposit form"):
